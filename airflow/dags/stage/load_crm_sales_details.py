...
S3_KEY = "datasets/source_crm/sales_details.csv"
TABLE = "stage.crm_sales_details"
...
with DAG(
    ...
    load_task = PythonOperator(
        task_id="load_crm_sales_details",
        python_callable=load_csv_to_postgres,
        op_kwargs={"s3_key": S3_KEY, "table": TABLE}
    )

    validate_task = PythonOperator(
        task_id="validate_crm_sales_details",
